    ...
    <div class="container">
        ...
        <?php
            if (isset($_POST['submit']))
            {
                ...
                {
                    echo "<div class = 'message'><p style = 'color:black;'>Wrong Username or Password</p></div><br>";
        ...
        ?>
            ...
            <form action="" method="POST">
                ...
                <div class="field input">
                    ...
                    <input type="password" name="password" id ="password" placeholder="Provide your password here" required>
                </div>
            ...
            <a href="../blog" class = 'backwards'><button class = "btn">Go back to blog</button></a>
        </div>
        <?php } ?>
    </div>
